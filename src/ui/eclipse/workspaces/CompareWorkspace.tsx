  ...
  return (
    <div className="h-full w-full flex flex-col p-6 overflow-hidden bg-[#09090B] text-[#FAFAFA] select-none">
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-5 min-h-0 pt-2 pb-2">
        ...
        <div className="bg-[#111114] border border-[#27272A] rounded-2xl p-5 flex flex-col justify-between overflow-y-auto">
          <div className="space-y-4">
            ...
            <div>
              <h2 className="text-[18px] font-semibold text-[#FAFAFA]">Passive Observation</h2>
            ...
            <div className="space-y-2 pt-2 border-t border-[#27272A]">
              <div className="flex justify-between text-[12px]">
                <span className="text-[#A1A1AA]">Peak R₀</span>
                <span className="font-mono text-[#EF4444] font-bold">
                  {baseline ? baseline.peakR0.toFixed(2) : '1.85'}
                </span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-[#A1A1AA]">Final Believers</span>
                <span className="font-mono text-[#EF4444] font-bold">
                  {baseline ? `${baseline.finalBelieverCount} nodes (${baseline.finalAdoptionRate.toFixed(0)}%)` : '54%'}
                </span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-[#A1A1AA]">Intervention Cost</span>
                <span className="font-mono text-[#22C55E]">0 units (Free)</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-[#A1A1AA]">Containment Delta</span>
                <span className="font-mono text-[#71717A]">0% (Baseline Reference)</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-[#27272A]">
            <button
              ...
              className="w-full py-2 px-3 rounded-lg bg-[#18181B] hover:bg-[#27272A] border border-[#27272A] text-[12px] font-medium text-[#A1A1AA] hover:text-[#FAFAFA] transition-colors cursor-pointer"
            >
              Simulate Baseline
            </button>
          </div>
        ...
        <div className={`bg-[#111114] rounded-2xl p-5 flex flex-col justify-between overflow-y-auto relative ${
          comparisonResult?.recommendedBranchId === 'bridge_inoculation'
            ? 'border-2 border-[#22C55E] shadow-2xl shadow-[#22C55E]/10'
            : 'border border-[#27272A]'
        }`}>
          {comparisonResult?.recommendedBranchId === 'bridge_inoculation' && (
            <div className="absolute -top-3 right-4 px-2.5 py-0.5 rounded-full bg-[#22C55E] text-[#09090B] text-[10px] font-mono font-bold uppercase tracking-wider">
              Recommended Choice
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <div>
              <h2 className="text-[18px] font-semibold text-[#FAFAFA]">Bridge Inoculation</h2>
              <p className="text-[12px] text-[#71717A] mt-1">
          ...
          <div className="pt-4 border-t border-[#27272A]">
            <motion.button
              ...
              className="w-full py-2.5 px-3 rounded-lg bg-[#22C55E] hover:bg-[#22C55E]/90 text-[#09090B] text-[13px] font-semibold flex items-center justify-center gap-1.5 cursor-pointer shadow-lg shadow-[#22C55E]/20"
            >
        ...
        <div className={`bg-[#111114] rounded-2xl p-5 flex flex-col justify-between overflow-y-auto relative ${
          ...
          {comparisonResult?.recommendedBranchId === 'influencer_containment' && (
            <div className="absolute -top-3 right-4 px-2.5 py-0.5 rounded-full bg-[#4F8CFF] text-[#09090B] text-[10px] font-mono font-bold uppercase tracking-wider">
              Recommended Choice
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <div>
              <h2 className="text-[18px] font-semibold text-[#FAFAFA]">Influencer Containment</h2>
              <p className="text-[12px] text-[#71717A] mt-1">
          ...
          <div className="pt-4 border-t border-[#27272A]">
            <button
              ...
              className="w-full py-2 px-3 rounded-lg bg-[#18181B] hover:bg-[#27272A] border border-[#27272A] text-[12px] font-medium text-[#FAFAFA] transition-colors cursor-pointer"
            >
